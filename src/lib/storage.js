...
export const K = { prefs: "ss_prefs", plan: "ss_plan", custom: "ss_custom_meals", settings: "ss_settings", favorites: "ss_favorites", pantry: "ss_pantry", history: "ss_history", notes: "ss_notes", hidden: "ss_hidden", shoppingEdits: "ss_shopping_edits" };
