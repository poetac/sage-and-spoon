...
It's an installable PWA — add it to your phone's home screen and the plan, cookbook (~500 recipes), and shopping list keep working offline (the AI features still need a connection).
